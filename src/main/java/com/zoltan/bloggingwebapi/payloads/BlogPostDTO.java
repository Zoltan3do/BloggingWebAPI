...
public record BlogPostDTO(
        ...
        @Size(min = 16, max = 150, message = "La lunghezza del contenuto deve essere tra i 16 e i 100 caratteri")
        String content,
        @NotNull(message = "Devi specificare chi è l'autore",groups = Create.class)
        User author
